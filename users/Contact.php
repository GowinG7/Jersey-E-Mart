...
<head>
    ...
    <?php
    require('links.php');
    require_once('db_config.php'); // Make sure this file contains your DB connection and helper functions
    ...
    if (!function_exists('insert')) {
         ...
         * @param string $types The types for bind_param (e.g., 'ssss').
         * @return int 1 on success, 0 on failure.
         */
        function insert($query, $params, $types)
        {
            global $con; // Assumes $con is your mysqli connection
...
<body>
    ...
    <div class="my-5 px-4">
        ...
        <p class="text-center mt-3 fs-5">
            If you have any queries or problems while using this system, please feel free to contact us. We respond
            within 24 hours through email or to your mobile number.
        </p>
    </div>

    <?php
    // Define select() function if not already defined
    if (!function_exists('select')) {
        /**
         * Select data from the database using prepared statements.
         * @param string $query The SQL query with placeholders.
         * @param array $params The values to bind.
         * @param string $types The types for bind_param (e.g., 'i').
            ...
            <div class="col-lg-6 col-md-6 col-12 mb-5 px-4">
                <div class="bg-white rounded shadow p-4">
                    <iframe class="w-100 rounded" height="320px"
                        src="<?php echo htmlspecialchars($contact_r['iframe']); ?>"></iframe>
                    <h5>Address</h5>
                    <a href="<?php echo htmlspecialchars($contact_r['gmap']); ?>" target="_blank"
                        class="d-inline-block text-decoration-none text-dark mb-2">
                        <i class="bi bi-geo-alt-fill"></i> <?php echo htmlspecialchars($contact_r['address']); ?>
                    </a>

                    <h5 class="mt-4">Call us</h5>
                    <a href="tel:+977-<?php echo htmlspecialchars($contact_r['pn1']); ?>"
                        class="d-inline-block mb-2 text-decoration-none text-dark">
                        <i class="bi bi-telephone-fill"></i> +977-<?php echo htmlspecialchars($contact_r['pn1']); ?>
                    </a>
                    <br>
                    <?php if (!empty($contact_r['pn2'])): ?>
                        <a href="tel:+977-<?php echo htmlspecialchars($contact_r['pn2']); ?>"
                    ...
                    <a href="mailto:<?php echo htmlspecialchars($contact_r['email']); ?>"
                        class="d-inline-block mb-2 text-decoration-none text-dark">
                ...
                <div class="bg-white rounded shadow p-4">
                    <form name="contactForm" method="POST" onsubmit="return validateForm()">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="subject" name="subject" type="text" class="form-control shadow-none"
                        ...
                        <div class="mt-3">
                            ...
                            <textarea id="message" name="message" class="form-control shadow-none" rows="5"
    ...
    <?php
    // Define alert function if not already defined
    if (!function_exists('alert')) {
        function alert($type, $msg)
        {
            $alertType = ($type === 'success') ? 'alert-success' : 'alert-danger';
            echo '<div class="alert ' . $alertType . ' custom-alert alert-dismissible fade show" role="alert">';
    ...
    if (isset($_POST['send'])) {
        // Define filteration function if not already defined
