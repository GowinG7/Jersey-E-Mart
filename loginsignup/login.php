        ...
        $(document).ready(function () {
            ...
            $("#username").on("input", function () {
                ...
                if (usernamePattern.test(input) || emailPattern.test(input)) {
                    $("#username_error").text("").hide(); // Clear error message and hide
                } else {
                    $("#username_error").text("Username can only contain letters, numbers, underscores, and the @ symbol, or email only contains a-z,0-9 and (.) and must end with @gmail.com, @yahoo.com, or @outlook.com.").show();
                }
            });
            ...
            $("#password").on("input", function () {
                ...
                if (password.length >= 8) {
                    $("#password_error").text("").hide(); // Clear error message and hide
                } else {
